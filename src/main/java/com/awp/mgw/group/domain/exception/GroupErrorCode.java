...
public enum GroupErrorCode implements BaseCode {
    ...
    GROUP_MEMBER_NOT_FOUND(HttpStatus.BAD_REQUEST, "GROUP-005", "그룹 멤버 정보를 찾을 수 없습니다."),
    GROUP_CATEGORY_NOT_FOUND(HttpStatus.BAD_REQUEST, "GROUP-006", "그룹 카테고리 정보를 찾을 수 없습니다."),
